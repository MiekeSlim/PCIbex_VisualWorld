    ...
    getEyeTracker("tracker")
        ...
        .test.score(50)
            .failure(
                ...
                ,
                newText("FailedCalibration1","Unfortunately, the calibration failed. Press space to try again! <br> Attempts left: 2")
                    .print("center at 50%", "middle at 50%")
                ,
                newKey("next", " ")
                    .wait(newEyeTracker("tracker").test.ready())
                ...
                getEyeTracker("tracker")
                    ...
                    .test.score(50)
                        ...
                        getCanvas("myCanvas").remove()
                        ,
                        newText("FailedCalibration2","Unfortunately, the calibration failed. Press space to try again! <br> Attempts left: 1")
                            .print("center at 50%", "middle at 50%")
                        ,
                        newKey("next", " ")
                            .wait(newEyeTracker("tracker").test.ready())
